...
NameSpace_Nicolas_Slider.Modul_Allein = (function () {
    ...
    function sliderStart(obererWert_, sliderX_) {
        ...
        sliderX.addEventListener('pointerdown', function (e) { textX.style.visibility = 'visible'; }, false);
        document.addEventListener('pointerup', function (e) { textX.style.visibility = 'hidden'; }, false);

        sliderX.addEventListener('pointermove', mouseMove, false);
    }
    ...
    function slider_alle_StyleSet_HandlerClick() {
        ...
        sliderX.style.margin = '10px 0px 10px 30px'
    ...
    function mouseMove(e) {
        ...
        if (e.buttons === 1) {
            ...
            //Minus halbe Breite von regler1(10) für Cursor in der Mitte
            //IE kennt window.scrollX nicht! :(
            if (window.scrollX) {
                AktuellX -= window.scrollX + mar_bor_pad + 10;
            } else {
                AktuellX -= window.pageXOffset + mar_bor_pad + 10;
            }
